...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openHorizontalBox("Simple Vocoder");
		...
		ui_interface->addHorizontalSlider("Release", &fHslider3, FAUSTFLOAT(5.0f), FAUSTFLOAT(0.1f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fHslider0, "2", "");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->addHorizontalSlider("BW", &fHslider0, FAUSTFLOAT(0.2f), FAUSTFLOAT(0.1f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openVerticalBox("Excitation");
		ui_interface->declare(&fHslider1, "0", "");
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->addHorizontalSlider("Frequency", &fHslider1, FAUSTFLOAT(1.4e+02f), FAUSTFLOAT(5e+01f), FAUSTFLOAT(2e+03f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow5 = fConst4 * float(fHslider1);
		float fSlow6 = 0.001f * float(fVslider0);
		float fSlow7 = float(fHslider2);
		float fSlow8 = (((0.001f * fSlow7) > 0.0f) ? std::exp(-(fConst5 / fSlow7)) : 0.0f);
		float fSlow9 = 1.0f - fSlow8;
		float fSlow10 = fConst3 / fSlow3;
		float fSlow11 = float(fHslider3);
		float fSlow12 = (((0.001f * fSlow11) > 0.0f) ? std::exp(-(fConst5 / fSlow11)) : 0.0f);
		float fSlow13 = 1.0f - fSlow12;
		float fSlow14 = 0.17712227f * fSlow0;
		float fSlow15 = fConst8 * (fConst8 - fSlow14) + 1.0f;
		float fSlow16 = fConst8 * (fConst8 + fSlow14) + 1.0f;
		...
		float fSlow21 = fConst11 * (fConst11 + fSlow19) + 1.0f;
		float fSlow22 = 1.0f / fSlow21;
		float fSlow23 = fConst11 / fSlow21;
		float fSlow24 = 0.17712227f * fSlow0;
		float fSlow25 = fConst14 * (fConst14 - fSlow24) + 1.0f;
		float fSlow26 = fConst14 * (fConst14 + fSlow24) + 1.0f;
		float fSlow27 = 1.0f / fSlow26;
		float fSlow28 = fConst14 / fSlow26;
		float fSlow29 = 0.17712227f * fSlow0;
		float fSlow30 = fConst17 * (fConst17 - fSlow29) + 1.0f;
		float fSlow31 = fConst17 * (fConst17 + fSlow29) + 1.0f;
		float fSlow32 = 1.0f / fSlow31;
		float fSlow33 = fConst17 / fSlow31;
		float fSlow34 = 0.17712227f * fSlow0;
		float fSlow35 = fConst20 * (fConst20 - fSlow34) + 1.0f;
		float fSlow36 = fConst20 * (fConst20 + fSlow34) + 1.0f;
		float fSlow37 = 1.0f / fSlow36;
		float fSlow38 = fConst20 / fSlow36;
		float fSlow39 = fConst23 * (fConst23 - fSlow24) + 1.0f;
		float fSlow40 = fConst23 * (fConst23 + fSlow24) + 1.0f;
		float fSlow41 = 1.0f / fSlow40;
		float fSlow42 = fConst23 / fSlow40;
		float fSlow43 = 0.17712227f * fSlow0;
		float fSlow44 = fConst26 * (fConst26 - fSlow43) + 1.0f;
		float fSlow45 = fConst26 * (fConst26 + fSlow43) + 1.0f;
		float fSlow46 = 1.0f / fSlow45;
		float fSlow47 = fConst26 / fSlow45;
		float fSlow48 = fConst29 * (fConst29 - fSlow1) + 1.0f;
		float fSlow49 = fConst29 * (fConst29 + fSlow1) + 1.0f;
		float fSlow50 = 1.0f / fSlow49;
		float fSlow51 = fConst29 / fSlow49;
		float fSlow52 = 0.17712227f * fSlow0;
		float fSlow53 = fConst32 * (fConst32 - fSlow52) + 1.0f;
		float fSlow54 = fConst32 * (fConst32 + fSlow52) + 1.0f;
		float fSlow55 = 1.0f / fSlow54;
		float fSlow56 = fConst32 / fSlow54;
		float fSlow57 = fConst35 * (fConst35 - fSlow19) + 1.0f;
		float fSlow58 = fConst35 * (fConst35 + fSlow19) + 1.0f;
		float fSlow59 = 1.0f / fSlow58;
		float fSlow60 = fConst35 / fSlow58;
		float fSlow61 = fConst38 * (fConst38 - fSlow52) + 1.0f;
		float fSlow62 = fConst38 * (fConst38 + fSlow52) + 1.0f;
		float fSlow63 = 1.0f / fSlow62;
		float fSlow64 = fConst38 / fSlow62;
		float fSlow65 = fConst41 * (fConst41 - fSlow19) + 1.0f;
		float fSlow66 = fConst41 * (fConst41 + fSlow19) + 1.0f;
		float fSlow67 = 1.0f / fSlow66;
		float fSlow68 = fConst41 / fSlow66;
		float fSlow69 = 0.17712227f * fSlow0;
		float fSlow70 = fConst44 * (fConst44 - fSlow69) + 1.0f;
		float fSlow71 = fConst44 * (fConst44 + fSlow69) + 1.0f;
		float fSlow72 = 1.0f / fSlow71;
		float fSlow73 = fConst44 / fSlow71;
		float fSlow74 = 0.17712227f * fSlow0;
		float fSlow75 = fConst47 * (fConst47 - fSlow74) + 1.0f;
		float fSlow76 = fConst47 * (fConst47 + fSlow74) + 1.0f;
		float fSlow77 = 1.0f / fSlow76;
		float fSlow78 = fConst47 / fSlow76;
		float fSlow79 = 0.17712227f * fSlow0;
		float fSlow80 = fConst50 * (fConst50 - fSlow79) + 1.0f;
		float fSlow81 = fConst50 * (fConst50 + fSlow79) + 1.0f;
		float fSlow82 = 1.0f / fSlow81;
		float fSlow83 = fConst50 / fSlow81;
		float fSlow84 = fConst53 * (fConst53 - fSlow43) + 1.0f;
		float fSlow85 = fConst53 * (fConst53 + fSlow43) + 1.0f;
		float fSlow86 = 1.0f / fSlow85;
		float fSlow87 = fConst53 / fSlow85;
		float fSlow88 = fConst56 * (fConst56 - fSlow43) + 1.0f;
		float fSlow89 = fConst56 * (fConst56 + fSlow43) + 1.0f;
		float fSlow90 = 1.0f / fSlow89;
		float fSlow91 = fConst56 / fSlow89;
		float fSlow92 = fConst59 * (fConst59 - fSlow19) + 1.0f;
		float fSlow93 = fConst59 * (fConst59 + fSlow19) + 1.0f;
		float fSlow94 = 1.0f / fSlow93;
		float fSlow95 = fConst59 / fSlow93;
		float fSlow96 = fConst62 * (fConst62 - fSlow34) + 1.0f;
		float fSlow97 = fConst62 * (fConst62 + fSlow34) + 1.0f;
		float fSlow98 = 1.0f / fSlow97;
		float fSlow99 = fConst62 / fSlow97;
		float fSlow100 = 0.17712227f * fSlow0;
		float fSlow101 = fConst65 * (fConst65 - fSlow100) + 1.0f;
		float fSlow102 = fConst65 * (fConst65 + fSlow100) + 1.0f;
		float fSlow103 = 1.0f / fSlow102;
		float fSlow104 = fConst65 / fSlow102;
		float fSlow105 = fConst68 * (fConst68 - fSlow34) + 1.0f;
		float fSlow106 = fConst68 * (fConst68 + fSlow34) + 1.0f;
		float fSlow107 = 1.0f / fSlow106;
		float fSlow108 = fConst68 / fSlow106;
		float fSlow109 = fConst71 * (fConst71 - fSlow79) + 1.0f;
		float fSlow110 = fConst71 * (fConst71 + fSlow79) + 1.0f;
		float fSlow111 = 1.0f / fSlow110;
		float fSlow112 = fConst71 / fSlow110;
		float fSlow113 = fConst74 * (fConst74 - fSlow69) + 1.0f;
		float fSlow114 = fConst74 * (fConst74 + fSlow69) + 1.0f;
		float fSlow115 = 1.0f / fSlow114;
		float fSlow116 = fConst74 / fSlow114;
		float fSlow117 = fConst77 * (fConst77 - fSlow24) + 1.0f;
		float fSlow118 = fConst77 * (fConst77 + fSlow24) + 1.0f;
		float fSlow119 = 1.0f / fSlow118;
		float fSlow120 = fConst77 / fSlow118;
		float fSlow121 = fConst80 * (fConst80 - fSlow52) + 1.0f;
		float fSlow122 = fConst80 * (fConst80 + fSlow52) + 1.0f;
		float fSlow123 = 1.0f / fSlow122;
		float fSlow124 = fConst80 / fSlow122;
		float fSlow125 = 0.17712227f * fSlow0;
		float fSlow126 = fConst83 * (fConst83 - fSlow125) + 1.0f;
		float fSlow127 = fConst83 * (fConst83 + fSlow125) + 1.0f;
		float fSlow128 = 1.0f / fSlow127;
		float fSlow129 = fConst83 / fSlow127;
		float fSlow130 = fConst86 * (fConst86 - fSlow69) + 1.0f;
		float fSlow131 = fConst86 * (fConst86 + fSlow69) + 1.0f;
		float fSlow132 = 1.0f / fSlow131;
		float fSlow133 = fConst86 / fSlow131;
		float fSlow134 = fConst89 * (fConst89 - fSlow43) + 1.0f;
		float fSlow135 = fConst89 * (fConst89 + fSlow43) + 1.0f;
		float fSlow136 = 1.0f / fSlow135;
		float fSlow137 = fConst89 / fSlow135;
		float fSlow138 = fConst92 * (fConst92 - fSlow24) + 1.0f;
		float fSlow139 = fConst92 * (fConst92 + fSlow24) + 1.0f;
		float fSlow140 = 1.0f / fSlow139;
		float fSlow141 = fConst92 / fSlow139;
		float fSlow142 = fConst95 * (fConst95 - fSlow79) + 1.0f;
		float fSlow143 = fConst95 * (fConst95 + fSlow79) + 1.0f;
		float fSlow144 = 1.0f / fSlow143;
		float fSlow145 = fConst95 / fSlow143;
		float fSlow146 = fConst98 * (fConst98 - fSlow24) + 1.0f;
		float fSlow147 = fConst98 * (fConst98 + fSlow24) + 1.0f;
		float fSlow148 = 1.0f / fSlow147;
		float fSlow149 = fConst98 / fSlow147;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec1[0] = fSlow5 + (fRec1[1] - std::floor(fSlow5 + fRec1[1]));
			fRec2[0] = fSlow6 + 0.999f * fRec2[1];
			float fTemp0 = fRec2[0] * float((fRec1[0] - fRec1[1]) < 0.0f);
			fRec0[0] = fTemp0 - fSlow4 * (fSlow2 * fRec0[2] + fConst2 * fRec0[1]);
			float fTemp1 = float(input0[i0]);
			fRec5[0] = fTemp1 - fSlow4 * (fSlow2 * fRec5[2] + fConst2 * fRec5[1]);
			float fTemp2 = std::fabs(fSlow10 * (fRec5[0] - fRec5[2]));
			fRec4[0] = std::max<float>(fTemp2, fSlow12 * fRec4[1] + fSlow13 * fTemp2);
			fRec3[0] = fSlow8 * fRec3[1] + fRec4[0] * fSlow9;
			fRec6[0] = fTemp0 - fSlow17 * (fSlow15 * fRec6[2] + fConst7 * fRec6[1]);
			fRec9[0] = fTemp1 - fSlow17 * (fSlow15 * fRec9[2] + fConst7 * fRec9[1]);
			float fTemp3 = std::fabs(fSlow18 * (fRec9[0] - fRec9[2]));
			fRec8[0] = std::max<float>(fTemp3, fSlow12 * fRec8[1] + fSlow13 * fTemp3);
			fRec7[0] = fSlow8 * fRec7[1] + fRec8[0] * fSlow9;
			fRec10[0] = fTemp0 - fSlow22 * (fSlow20 * fRec10[2] + fConst10 * fRec10[1]);
			fRec13[0] = fTemp1 - fSlow22 * (fSlow20 * fRec13[2] + fConst10 * fRec13[1]);
			float fTemp4 = std::fabs(fSlow23 * (fRec13[0] - fRec13[2]));
			fRec12[0] = std::max<float>(fTemp4, fSlow12 * fRec12[1] + fSlow13 * fTemp4);
			fRec11[0] = fSlow8 * fRec11[1] + fRec12[0] * fSlow9;
			fRec14[0] = fTemp0 - fSlow27 * (fSlow25 * fRec14[2] + fConst13 * fRec14[1]);
			fRec17[0] = fTemp1 - fSlow27 * (fSlow25 * fRec17[2] + fConst13 * fRec17[1]);
			float fTemp5 = std::fabs(fSlow28 * (fRec17[0] - fRec17[2]));
			fRec16[0] = std::max<float>(fTemp5, fSlow12 * fRec16[1] + fSlow13 * fTemp5);
			fRec15[0] = fSlow8 * fRec15[1] + fRec16[0] * fSlow9;
			fRec18[0] = fTemp0 - fSlow32 * (fSlow30 * fRec18[2] + fConst16 * fRec18[1]);
			fRec21[0] = fTemp1 - fSlow32 * (fSlow30 * fRec21[2] + fConst16 * fRec21[1]);
			float fTemp6 = std::fabs(fSlow33 * (fRec21[0] - fRec21[2]));
			fRec20[0] = std::max<float>(fTemp6, fSlow12 * fRec20[1] + fSlow13 * fTemp6);
			fRec19[0] = fSlow8 * fRec19[1] + fRec20[0] * fSlow9;
			fRec22[0] = fTemp0 - fSlow37 * (fSlow35 * fRec22[2] + fConst19 * fRec22[1]);
			fRec25[0] = fTemp1 - fSlow37 * (fSlow35 * fRec25[2] + fConst19 * fRec25[1]);
			float fTemp7 = std::fabs(fSlow38 * (fRec25[0] - fRec25[2]));
			fRec24[0] = std::max<float>(fTemp7, fSlow12 * fRec24[1] + fSlow13 * fTemp7);
			fRec23[0] = fSlow8 * fRec23[1] + fRec24[0] * fSlow9;
			fRec26[0] = fTemp0 - fSlow41 * (fSlow39 * fRec26[2] + fConst22 * fRec26[1]);
			fRec29[0] = fTemp1 - fSlow41 * (fSlow39 * fRec29[2] + fConst22 * fRec29[1]);
			float fTemp8 = std::fabs(fSlow42 * (fRec29[0] - fRec29[2]));
			fRec28[0] = std::max<float>(fTemp8, fSlow12 * fRec28[1] + fSlow13 * fTemp8);
			fRec27[0] = fSlow8 * fRec27[1] + fRec28[0] * fSlow9;
			fRec30[0] = fTemp0 - fSlow46 * (fSlow44 * fRec30[2] + fConst25 * fRec30[1]);
			fRec33[0] = fTemp1 - fSlow46 * (fSlow44 * fRec33[2] + fConst25 * fRec33[1]);
			float fTemp9 = std::fabs(fSlow47 * (fRec33[0] - fRec33[2]));
			fRec32[0] = std::max<float>(fTemp9, fSlow12 * fRec32[1] + fSlow13 * fTemp9);
			fRec31[0] = fSlow8 * fRec31[1] + fRec32[0] * fSlow9;
			fRec34[0] = fTemp0 - fSlow50 * (fSlow48 * fRec34[2] + fConst28 * fRec34[1]);
			fRec37[0] = fTemp1 - fSlow50 * (fSlow48 * fRec37[2] + fConst28 * fRec37[1]);
			float fTemp10 = std::fabs(fSlow51 * (fRec37[0] - fRec37[2]));
			fRec36[0] = std::max<float>(fTemp10, fSlow12 * fRec36[1] + fSlow13 * fTemp10);
			fRec35[0] = fSlow8 * fRec35[1] + fRec36[0] * fSlow9;
			fRec38[0] = fTemp0 - fSlow55 * (fSlow53 * fRec38[2] + fConst31 * fRec38[1]);
			fRec41[0] = fTemp1 - fSlow55 * (fSlow53 * fRec41[2] + fConst31 * fRec41[1]);
			float fTemp11 = std::fabs(fSlow56 * (fRec41[0] - fRec41[2]));
			fRec40[0] = std::max<float>(fTemp11, fSlow12 * fRec40[1] + fSlow13 * fTemp11);
			fRec39[0] = fSlow8 * fRec39[1] + fRec40[0] * fSlow9;
			fRec42[0] = fTemp0 - fSlow59 * (fSlow57 * fRec42[2] + fConst34 * fRec42[1]);
			fRec45[0] = fTemp1 - fSlow59 * (fSlow57 * fRec45[2] + fConst34 * fRec45[1]);
			float fTemp12 = std::fabs(fSlow60 * (fRec45[0] - fRec45[2]));
			fRec44[0] = std::max<float>(fTemp12, fSlow12 * fRec44[1] + fSlow13 * fTemp12);
			fRec43[0] = fSlow8 * fRec43[1] + fRec44[0] * fSlow9;
			fRec46[0] = fTemp0 - fSlow63 * (fSlow61 * fRec46[2] + fConst37 * fRec46[1]);
			fRec49[0] = fTemp1 - fSlow63 * (fSlow61 * fRec49[2] + fConst37 * fRec49[1]);
			float fTemp13 = std::fabs(fSlow64 * (fRec49[0] - fRec49[2]));
			fRec48[0] = std::max<float>(fTemp13, fSlow12 * fRec48[1] + fSlow13 * fTemp13);
			fRec47[0] = fSlow8 * fRec47[1] + fRec48[0] * fSlow9;
			fRec50[0] = fTemp0 - fSlow67 * (fSlow65 * fRec50[2] + fConst40 * fRec50[1]);
			fRec53[0] = fTemp1 - fSlow67 * (fSlow65 * fRec53[2] + fConst40 * fRec53[1]);
			float fTemp14 = std::fabs(fSlow68 * (fRec53[0] - fRec53[2]));
			fRec52[0] = std::max<float>(fTemp14, fSlow12 * fRec52[1] + fSlow13 * fTemp14);
			fRec51[0] = fSlow8 * fRec51[1] + fRec52[0] * fSlow9;
			fRec54[0] = fTemp0 - fSlow72 * (fSlow70 * fRec54[2] + fConst43 * fRec54[1]);
			fRec57[0] = fTemp1 - fSlow72 * (fSlow70 * fRec57[2] + fConst43 * fRec57[1]);
			float fTemp15 = std::fabs(fSlow73 * (fRec57[0] - fRec57[2]));
			fRec56[0] = std::max<float>(fTemp15, fSlow12 * fRec56[1] + fSlow13 * fTemp15);
			fRec55[0] = fSlow8 * fRec55[1] + fRec56[0] * fSlow9;
			fRec58[0] = fTemp0 - fSlow77 * (fSlow75 * fRec58[2] + fConst46 * fRec58[1]);
			fRec61[0] = fTemp1 - fSlow77 * (fSlow75 * fRec61[2] + fConst46 * fRec61[1]);
			float fTemp16 = std::fabs(fSlow78 * (fRec61[0] - fRec61[2]));
			fRec60[0] = std::max<float>(fTemp16, fSlow12 * fRec60[1] + fSlow13 * fTemp16);
			fRec59[0] = fSlow8 * fRec59[1] + fRec60[0] * fSlow9;
			fRec62[0] = fTemp0 - fSlow82 * (fSlow80 * fRec62[2] + fConst49 * fRec62[1]);
			fRec65[0] = fTemp1 - fSlow82 * (fSlow80 * fRec65[2] + fConst49 * fRec65[1]);
			float fTemp17 = std::fabs(fSlow83 * (fRec65[0] - fRec65[2]));
			fRec64[0] = std::max<float>(fTemp17, fSlow12 * fRec64[1] + fSlow13 * fTemp17);
			fRec63[0] = fSlow8 * fRec63[1] + fRec64[0] * fSlow9;
			fRec66[0] = fTemp0 - fSlow86 * (fSlow84 * fRec66[2] + fConst52 * fRec66[1]);
			fRec69[0] = fTemp1 - fSlow86 * (fSlow84 * fRec69[2] + fConst52 * fRec69[1]);
			float fTemp18 = std::fabs(fSlow87 * (fRec69[0] - fRec69[2]));
			fRec68[0] = std::max<float>(fTemp18, fSlow12 * fRec68[1] + fSlow13 * fTemp18);
			fRec67[0] = fSlow8 * fRec67[1] + fRec68[0] * fSlow9;
			fRec70[0] = fTemp0 - fSlow90 * (fSlow88 * fRec70[2] + fConst55 * fRec70[1]);
			fRec73[0] = fTemp1 - fSlow90 * (fSlow88 * fRec73[2] + fConst55 * fRec73[1]);
			float fTemp19 = std::fabs(fSlow91 * (fRec73[0] - fRec73[2]));
			fRec72[0] = std::max<float>(fTemp19, fSlow12 * fRec72[1] + fSlow13 * fTemp19);
			fRec71[0] = fSlow8 * fRec71[1] + fRec72[0] * fSlow9;
			fRec74[0] = fTemp0 - fSlow94 * (fSlow92 * fRec74[2] + fConst58 * fRec74[1]);
			fRec77[0] = fTemp1 - fSlow94 * (fSlow92 * fRec77[2] + fConst58 * fRec77[1]);
			float fTemp20 = std::fabs(fSlow95 * (fRec77[0] - fRec77[2]));
			fRec76[0] = std::max<float>(fTemp20, fSlow12 * fRec76[1] + fSlow13 * fTemp20);
			fRec75[0] = fSlow8 * fRec75[1] + fRec76[0] * fSlow9;
			fRec78[0] = fTemp0 - fSlow98 * (fSlow96 * fRec78[2] + fConst61 * fRec78[1]);
			fRec81[0] = fTemp1 - fSlow98 * (fSlow96 * fRec81[2] + fConst61 * fRec81[1]);
			float fTemp21 = std::fabs(fSlow99 * (fRec81[0] - fRec81[2]));
			fRec80[0] = std::max<float>(fTemp21, fSlow12 * fRec80[1] + fSlow13 * fTemp21);
			fRec79[0] = fSlow8 * fRec79[1] + fRec80[0] * fSlow9;
			fRec82[0] = fTemp0 - fSlow103 * (fSlow101 * fRec82[2] + fConst64 * fRec82[1]);
			fRec85[0] = fTemp1 - fSlow103 * (fSlow101 * fRec85[2] + fConst64 * fRec85[1]);
			float fTemp22 = std::fabs(fSlow104 * (fRec85[0] - fRec85[2]));
			fRec84[0] = std::max<float>(fTemp22, fSlow12 * fRec84[1] + fSlow13 * fTemp22);
			fRec83[0] = fSlow8 * fRec83[1] + fRec84[0] * fSlow9;
			fRec86[0] = fTemp0 - fSlow107 * (fSlow105 * fRec86[2] + fConst67 * fRec86[1]);
			fRec89[0] = fTemp1 - fSlow107 * (fSlow105 * fRec89[2] + fConst67 * fRec89[1]);
			float fTemp23 = std::fabs(fSlow108 * (fRec89[0] - fRec89[2]));
			fRec88[0] = std::max<float>(fTemp23, fSlow12 * fRec88[1] + fSlow13 * fTemp23);
			fRec87[0] = fSlow8 * fRec87[1] + fRec88[0] * fSlow9;
			fRec90[0] = fTemp0 - fSlow111 * (fSlow109 * fRec90[2] + fConst70 * fRec90[1]);
			fRec93[0] = fTemp1 - fSlow111 * (fSlow109 * fRec93[2] + fConst70 * fRec93[1]);
			float fTemp24 = std::fabs(fSlow112 * (fRec93[0] - fRec93[2]));
			fRec92[0] = std::max<float>(fTemp24, fSlow12 * fRec92[1] + fSlow13 * fTemp24);
			fRec91[0] = fSlow8 * fRec91[1] + fRec92[0] * fSlow9;
			fRec94[0] = fTemp0 - fSlow115 * (fSlow113 * fRec94[2] + fConst73 * fRec94[1]);
			fRec97[0] = fTemp1 - fSlow115 * (fSlow113 * fRec97[2] + fConst73 * fRec97[1]);
			float fTemp25 = std::fabs(fSlow116 * (fRec97[0] - fRec97[2]));
			fRec96[0] = std::max<float>(fTemp25, fSlow12 * fRec96[1] + fSlow13 * fTemp25);
			fRec95[0] = fSlow8 * fRec95[1] + fRec96[0] * fSlow9;
			fRec98[0] = fTemp0 - fSlow119 * (fSlow117 * fRec98[2] + fConst76 * fRec98[1]);
			fRec101[0] = fTemp1 - fSlow119 * (fSlow117 * fRec101[2] + fConst76 * fRec101[1]);
			float fTemp26 = std::fabs(fSlow120 * (fRec101[0] - fRec101[2]));
			fRec100[0] = std::max<float>(fTemp26, fSlow12 * fRec100[1] + fSlow13 * fTemp26);
			fRec99[0] = fSlow8 * fRec99[1] + fRec100[0] * fSlow9;
			fRec102[0] = fTemp0 - fSlow123 * (fSlow121 * fRec102[2] + fConst79 * fRec102[1]);
			fRec105[0] = fTemp1 - fSlow123 * (fSlow121 * fRec105[2] + fConst79 * fRec105[1]);
			float fTemp27 = std::fabs(fSlow124 * (fRec105[0] - fRec105[2]));
			fRec104[0] = std::max<float>(fTemp27, fSlow12 * fRec104[1] + fSlow13 * fTemp27);
			fRec103[0] = fSlow8 * fRec103[1] + fRec104[0] * fSlow9;
			fRec106[0] = fTemp0 - fSlow128 * (fSlow126 * fRec106[2] + fConst82 * fRec106[1]);
			fRec109[0] = fTemp1 - fSlow128 * (fSlow126 * fRec109[2] + fConst82 * fRec109[1]);
			float fTemp28 = std::fabs(fSlow129 * (fRec109[0] - fRec109[2]));
			fRec108[0] = std::max<float>(fTemp28, fSlow12 * fRec108[1] + fSlow13 * fTemp28);
			fRec107[0] = fSlow8 * fRec107[1] + fRec108[0] * fSlow9;
			fRec110[0] = fTemp0 - fSlow132 * (fSlow130 * fRec110[2] + fConst85 * fRec110[1]);
			fRec113[0] = fTemp1 - fSlow132 * (fSlow130 * fRec113[2] + fConst85 * fRec113[1]);
			float fTemp29 = std::fabs(fSlow133 * (fRec113[0] - fRec113[2]));
			fRec112[0] = std::max<float>(fTemp29, fSlow12 * fRec112[1] + fSlow13 * fTemp29);
			fRec111[0] = fSlow8 * fRec111[1] + fRec112[0] * fSlow9;
			fRec114[0] = fTemp0 - fSlow136 * (fSlow134 * fRec114[2] + fConst88 * fRec114[1]);
			fRec117[0] = fTemp1 - fSlow136 * (fSlow134 * fRec117[2] + fConst88 * fRec117[1]);
			float fTemp30 = std::fabs(fSlow137 * (fRec117[0] - fRec117[2]));
			fRec116[0] = std::max<float>(fTemp30, fSlow12 * fRec116[1] + fSlow13 * fTemp30);
			fRec115[0] = fSlow8 * fRec115[1] + fRec116[0] * fSlow9;
			fRec118[0] = fTemp0 - fSlow140 * (fSlow138 * fRec118[2] + fConst91 * fRec118[1]);
			fRec121[0] = fTemp1 - fSlow140 * (fSlow138 * fRec121[2] + fConst91 * fRec121[1]);
			float fTemp31 = std::fabs(fSlow141 * (fRec121[0] - fRec121[2]));
			fRec120[0] = std::max<float>(fTemp31, fSlow12 * fRec120[1] + fSlow13 * fTemp31);
			fRec119[0] = fSlow8 * fRec119[1] + fRec120[0] * fSlow9;
			fRec122[0] = fTemp0 - fSlow144 * (fSlow142 * fRec122[2] + fConst94 * fRec122[1]);
			fRec125[0] = fTemp1 - fSlow144 * (fSlow142 * fRec125[2] + fConst94 * fRec125[1]);
			float fTemp32 = std::fabs(fSlow145 * (fRec125[0] - fRec125[2]));
			fRec124[0] = std::max<float>(fTemp32, fSlow12 * fRec124[1] + fSlow13 * fTemp32);
			fRec123[0] = fSlow8 * fRec123[1] + fRec124[0] * fSlow9;
			fRec126[0] = fTemp0 - fSlow148 * (fSlow146 * fRec126[2] + fConst97 * fRec126[1]);
			fRec129[0] = fTemp1 - fSlow148 * (fSlow146 * fRec129[2] + fConst97 * fRec129[1]);
			float fTemp33 = std::fabs(fSlow149 * (fRec129[0] - fRec129[2]));
			fRec128[0] = std::max<float>(fTemp33, fRec128[1] * fSlow12 + fTemp33 * fSlow13);
			fRec127[0] = fRec127[1] * fSlow8 + fRec128[0] * fSlow9;
			float fTemp34 = fSlow149 * fRec127[0] * (fRec126[0] - fRec126[2]) + fSlow145 * fRec123[0] * (fRec122[0] - fRec122[2]) + fSlow141 * fRec119[0] * (fRec118[0] - fRec118[2]) + fSlow137 * fRec115[0] * (fRec114[0] - fRec114[2]) + fSlow133 * fRec111[0] * (fRec110[0] - fRec110[2]) + fSlow129 * fRec107[0] * (fRec106[0] - fRec106[2]) + fSlow124 * fRec103[0] * (fRec102[0] - fRec102[2]) + fSlow120 * fRec99[0] * (fRec98[0] - fRec98[2]) + fSlow116 * fRec95[0] * (fRec94[0] - fRec94[2]) + fSlow112 * fRec91[0] * (fRec90[0] - fRec90[2]) + fSlow108 * fRec87[0] * (fRec86[0] - fRec86[2]) + fSlow104 * fRec83[0] * (fRec82[0] - fRec82[2]) + fSlow99 * fRec79[0] * (fRec78[0] - fRec78[2]) + fSlow95 * fRec75[0] * (fRec74[0] - fRec74[2]) + fSlow91 * fRec71[0] * (fRec70[0] - fRec70[2]) + fSlow87 * fRec67[0] * (fRec66[0] - fRec66[2]) + fSlow83 * fRec63[0] * (fRec62[0] - fRec62[2]) + fSlow78 * fRec59[0] * (fRec58[0] - fRec58[2]) + fSlow73 * fRec55[0] * (fRec54[0] - fRec54[2]) + fSlow68 * fRec51[0] * (fRec50[0] - fRec50[2]) + fSlow64 * fRec47[0] * (fRec46[0] - fRec46[2]) + fSlow60 * fRec43[0] * (fRec42[0] - fRec42[2]) + fSlow56 * fRec39[0] * (fRec38[0] - fRec38[2]) + fSlow51 * fRec35[0] * (fRec34[0] - fRec34[2]) + fSlow47 * fRec31[0] * (fRec30[0] - fRec30[2]) + fSlow42 * fRec27[0] * (fRec26[0] - fRec26[2]) + fSlow38 * fRec23[0] * (fRec22[0] - fRec22[2]) + fSlow33 * fRec19[0] * (fRec18[0] - fRec18[2]) + fSlow28 * fRec15[0] * (fRec14[0] - fRec14[2]) + fSlow23 * fRec11[0] * (fRec10[0] - fRec10[2]) + fSlow18 * fRec7[0] * (fRec6[0] - fRec6[2]) + fSlow10 * fRec3[0] * (fRec0[0] - fRec0[2]);
	...
	FAUST_ADDHORIZONTALSLIDER("Simple Vocoder/[0]Vocoder/Attack", fHslider2, 5.0f, 0.1f, 1e+02f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Simple Vocoder/[0]Vocoder/Release", fHslider3, 5.0f, 0.1f, 1e+02f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Simple Vocoder/[0]Vocoder/BW", fHslider0, 0.2f, 0.1f, 2.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Simple Vocoder/[1]Excitation/Frequency", fHslider1, 1.4e+02f, 5e+01f, 2e+03f, 0.1f);
	FAUST_ADDVERTICALSLIDER("Simple Vocoder/[1]Excitation/Gain", fVslider0, 0.5f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Attack, "Simple Vocoder/[0]Vocoder/Attack", fHslider2, 5.0f, 0.1f, 1e+02f, 0.1f) \
		p(HORIZONTALSLIDER, Release, "Simple Vocoder/[0]Vocoder/Release", fHslider3, 5.0f, 0.1f, 1e+02f, 0.1f) \
		p(HORIZONTALSLIDER, BW, "Simple Vocoder/[0]Vocoder/BW", fHslider0, 0.2f, 0.1f, 2.0f, 0.001f) \
		p(HORIZONTALSLIDER, Frequency, "Simple Vocoder/[1]Excitation/Frequency", fHslider1, 1.4e+02f, 5e+01f, 2e+03f, 0.1f) \
		p(VERTICALSLIDER, Gain, "Simple Vocoder/[1]Excitation/Gain", fVslider0, 0.5f, 0.0f, 1.0f, 0.01f) \
...
vocoder::vocoder() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void vocoder::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void vocoder::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float vocoder::getParamValue(const std::string& path)
{
