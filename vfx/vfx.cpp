...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("vfx");
		ui_interface->openVerticalBox("Pitch Shifter");
		ui_interface->addHorizontalSlider("shift (semitones)", &fHslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(-9.0f), FAUSTFLOAT(9.0f), FAUSTFLOAT(0.1f));
		ui_interface->closeBox();
		ui_interface->declare(&fHslider3, "unit", "ms");
		ui_interface->addHorizontalSlider("delay", &fHslider3, FAUSTFLOAT(2.5e+02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("feedback", &fHslider0, FAUSTFLOAT(3e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fHslider4, "unit", "ms");
		ui_interface->addHorizontalSlider("interpolation", &fHslider4, FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("room", &fHslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 0.8f * float(fHslider1) + 0.15f;
		float fSlow2 = 0.7f * fSlow1 + 0.25f;
		float fSlow3 = 0.4f * (fSlow1 + 1.0f);
		float fSlow4 = 0.6f - 0.4f * fSlow1;
		float fSlow5 = 0.6f * fSlow1 + 0.3f;
		float fSlow6 = std::pow(2.0f, 0.083333336f * float(fHslider2));
		float fSlow7 = 5e+01f * fSlow1;
		int iSlow8 = int(fConst1 + fSlow7);
		int iSlow9 = int(fConst2 + fSlow7);
		int iSlow10 = int(fConst3 + fSlow7);
		int iSlow11 = int(fConst4 + fSlow7);
		int iSlow12 = int(fConst5 + fSlow7);
		int iSlow13 = int(fConst6 + fSlow7);
		int iSlow14 = int(fConst7 + fSlow7);
		int iSlow15 = int(fConst8 + fSlow7);
		float fSlow16 = fSlow7 + -1.0f;
		int iSlow17 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst9 + fSlow16)));
		int iSlow18 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst10 + fSlow16)));
		int iSlow19 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst11 + fSlow16)));
		int iSlow20 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst12 + fSlow16)));
		float fSlow21 = fConst13 * float(fHslider3);
		float fSlow22 = fConst14 / float(fHslider4);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec10[0] = fSlow4 * fRec10[1] + fSlow3 * fRec9[1];
			fRec11[0] = std::fmod(fRec11[1] + 1001.0f - fSlow6, 1e+03f);
			float fTemp0 = std::min<float>(0.1f * fRec11[0], 1.0f);
			float fTemp1 = fRec11[0] + 1e+03f;
			float fTemp2 = std::floor(fTemp1);
			float fTemp3 = float(input0[i0]);
			fVec0[IOTA0 & 131071] = fTemp3;
			int iTemp4 = int(fTemp1);
			float fTemp5 = (fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp4))) & 131071] * (fTemp2 + (-999.0f - fRec11[0])) + fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp4 + 1))) & 131071] * (fRec11[0] + (1e+03f - fTemp2))) * (1.0f - fTemp0);
			int iTemp6 = int(fRec11[0]);
			float fTemp7 = std::floor(fRec11[0]);
			float fTemp8 = (fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp6))) & 131071] * (fTemp7 + (1.0f - fRec11[0])) + (fRec11[0] - fTemp7) * fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp6 + 1))) & 131071]) * fTemp0;
			float fTemp9 = fTemp8 + fTemp5;
			fVec1[IOTA0 & 8191] = fTemp9 + fSlow5 * fRec10[0];
			fRec9[0] = fVec1[(IOTA0 - iSlow8) & 8191];
			fRec13[0] = fSlow4 * fRec13[1] + fSlow3 * fRec12[1];
			fVec2[IOTA0 & 8191] = fTemp9 + fSlow5 * fRec13[0];
			fRec12[0] = fVec2[(IOTA0 - iSlow9) & 8191];
			fRec15[0] = fSlow4 * fRec15[1] + fSlow3 * fRec14[1];
			fVec3[IOTA0 & 8191] = fTemp9 + fSlow5 * fRec15[0];
			fRec14[0] = fVec3[(IOTA0 - iSlow10) & 8191];
			fRec17[0] = fSlow4 * fRec17[1] + fSlow3 * fRec16[1];
			fVec4[IOTA0 & 8191] = fTemp9 + fSlow5 * fRec17[0];
			fRec16[0] = fVec4[(IOTA0 - iSlow11) & 8191];
			fRec19[0] = fSlow4 * fRec19[1] + fSlow3 * fRec18[1];
			fVec5[IOTA0 & 8191] = fTemp9 + fSlow5 * fRec19[0];
			fRec18[0] = fVec5[(IOTA0 - iSlow12) & 8191];
			fRec21[0] = fSlow4 * fRec21[1] + fSlow3 * fRec20[1];
			fVec6[IOTA0 & 8191] = fTemp9 + fSlow5 * fRec21[0];
			fRec20[0] = fVec6[(IOTA0 - iSlow13) & 8191];
			fRec23[0] = fSlow4 * fRec23[1] + fSlow3 * fRec22[1];
			fVec7[IOTA0 & 8191] = fTemp9 + fSlow5 * fRec23[0];
			fRec22[0] = fVec7[(IOTA0 - iSlow14) & 8191];
			fRec25[0] = fSlow4 * fRec25[1] + fSlow3 * fRec24[1];
			fVec8[IOTA0 & 8191] = fTemp5 + fSlow5 * fRec25[0] + fTemp8;
			fRec24[0] = fVec8[(IOTA0 - iSlow15) & 8191];
			float fTemp10 = fRec24[0] + fRec22[0] + fRec20[0] + fRec18[0] + fRec16[0] + fRec14[0] + fRec12[0] + fRec9[0] + fSlow2 * fRec7[1];
			fVec9[IOTA0 & 2047] = fTemp10;
			fRec7[0] = fVec9[(IOTA0 - iSlow17) & 2047];
			float fRec8 = -(fSlow2 * fTemp10);
			float fTemp11 = fRec7[1] + fRec8 + fSlow2 * fRec5[1];
			fVec10[IOTA0 & 2047] = fTemp11;
			fRec5[0] = fVec10[(IOTA0 - iSlow18) & 2047];
			float fRec6 = -(fSlow2 * fTemp11);
			float fTemp12 = fRec5[1] + fRec6 + fSlow2 * fRec3[1];
			fVec11[IOTA0 & 2047] = fTemp12;
			fRec3[0] = fVec11[(IOTA0 - iSlow19) & 2047];
			float fRec4 = -(fSlow2 * fTemp12);
			float fTemp13 = fRec3[1] + fRec4 + fSlow2 * fRec1[1];
			fVec12[IOTA0 & 2047] = fTemp13;
			fRec1[0] = fVec12[(IOTA0 - iSlow20) & 2047];
			float fRec2 = -(fSlow2 * fTemp13);
			float fTemp14 = fRec1[1] + fRec2 + fSlow0 * fRec0[1];
			fVec13[IOTA0 & 1048575] = fTemp14;
			float fTemp15 = ((fRec26[1] != 0.0f) ? (((fRec27[1] > 0.0f) & (fRec27[1] < 1.0f)) ? fRec26[1] : 0.0f) : (((fRec27[1] == 0.0f) & (fSlow21 != fRec28[1])) ? fSlow22 : (((fRec27[1] == 1.0f) & (fSlow21 != fRec29[1])) ? -fSlow22 : 0.0f)));
			fRec26[0] = fTemp15;
			fRec27[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec27[1] + fTemp15));
			fRec28[0] = (((fRec27[1] >= 1.0f) & (fRec29[1] != fSlow21)) ? fSlow21 : fRec28[1]);
			fRec29[0] = (((fRec27[1] <= 0.0f) & (fRec28[1] != fSlow21)) ? fSlow21 : fRec29[1]);
			int iTemp16 = int(std::min<float>(524288.0f, std::max<float>(0.0f, fRec28[0])));
			float fTemp17 = fVec13[(IOTA0 - iTemp16) & 1048575];
			int iTemp18 = int(std::min<float>(524288.0f, std::max<float>(0.0f, fRec29[0])));
			fRec0[0] = fTemp17 + fRec27[0] * (fVec13[(IOTA0 - iTemp18) & 1048575] - fTemp17);
			output0[i0] = FAUSTFLOAT(fRec0[0]);
			float fTemp19 = float(input1[i0]) + fSlow0 * fRec30[1];
			fVec14[IOTA0 & 1048575] = fTemp19;
			float fTemp20 = fVec14[(IOTA0 - iTemp16) & 1048575];
			fRec30[0] = fTemp20 + fRec27[0] * (fVec14[(IOTA0 - iTemp18) & 1048575] - fTemp20);
			output1[i0] = FAUSTFLOAT(fRec30[0]);
			fRec10[1] = fRec10[0];
			fRec11[1] = fRec11[0];
			IOTA0 = IOTA0 + 1;
			fRec9[1] = fRec9[0];
	...
	#define FAUST_FILE_NAME "vfx.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Pitch Shifter/shift (semitones)", fHslider2, 0.0f, -9.0f, 9.0f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("delay", fHslider3, 2.5e+02f, 0.0f, 1e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("feedback", fHslider0, 3e+01f, 0.0f, 1e+02f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("interpolation", fHslider4, 1e+01f, 1.0f, 1e+02f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("room", fHslider1, 0.0f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, shift_(semitones), "Pitch Shifter/shift (semitones)", fHslider2, 0.0f, -9.0f, 9.0f, 0.1f) \
		p(HORIZONTALSLIDER, delay, "delay", fHslider3, 2.5e+02f, 0.0f, 1e+03f, 0.1f) \
		p(HORIZONTALSLIDER, feedback, "feedback", fHslider0, 3e+01f, 0.0f, 1e+02f, 0.1f) \
		p(HORIZONTALSLIDER, interpolation, "interpolation", fHslider4, 1e+01f, 1.0f, 1e+02f, 0.1f) \
		p(HORIZONTALSLIDER, room, "room", fHslider1, 0.0f, 0.0f, 1.0f, 0.01f) \
...
vfx::vfx() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void vfx::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void vfx::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float vfx::getParamValue(const std::string& path)
{
