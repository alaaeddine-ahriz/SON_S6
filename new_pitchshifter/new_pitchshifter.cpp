...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "new_pitchshifter.dsp");
		...
		m->declare("name", "new_pitchshifter");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("new_pitchshifter");
		ui_interface->addHorizontalSlider("room_size", &fHslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("shift", &fHslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(-12.0f), FAUSTFLOAT(12.0f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("window", &fHslider2, FAUSTFLOAT(1e+03f), FAUSTFLOAT(5e+01f), FAUSTFLOAT(1e+04f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("xfade", &fHslider3, FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+04f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 0.7f * fSlow0 + 0.25f;
		float fSlow2 = 0.4f * (fSlow0 + 1.0f);
		float fSlow3 = 0.6f - 0.4f * fSlow0;
		float fSlow4 = 0.6f * fSlow0 + 0.3f;
		float fSlow5 = std::pow(2.0f, 0.083333336f * float(fHslider1));
		float fSlow6 = float(fHslider2);
		float fSlow7 = 1.0f / float(fHslider3);
		float fSlow8 = 5e+01f * fSlow0;
		int iSlow9 = int(fConst1 + fSlow8);
		int iSlow10 = int(fConst2 + fSlow8);
		int iSlow11 = int(fConst3 + fSlow8);
		int iSlow12 = int(fConst4 + fSlow8);
		int iSlow13 = int(fConst5 + fSlow8);
		int iSlow14 = int(fConst6 + fSlow8);
		int iSlow15 = int(fConst7 + fSlow8);
		int iSlow16 = int(fConst8 + fSlow8);
		float fSlow17 = fSlow8 + -1.0f;
		int iSlow18 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst9 + fSlow17)));
		int iSlow19 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst10 + fSlow17)));
		int iSlow20 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst11 + fSlow17)));
		int iSlow21 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst12 + fSlow17)));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec9[0] = fSlow3 * fRec9[1] + fSlow2 * fRec8[1];
			fRec10[0] = std::fmod(fSlow6 + (fRec10[1] + 1.0f - fSlow5), fSlow6);
			float fTemp0 = std::min<float>(fSlow7 * fRec10[0], 1.0f);
			float fTemp1 = float(input0[i0]);
			fVec0[IOTA0 & 2047] = fTemp1;
			float fTemp2 = fSlow6 + fRec10[0];
			int iTemp3 = int(fTemp2);
			float fTemp4 = std::floor(fTemp2);
			float fTemp5 = 1.0f - fRec10[0];
			float fTemp6 = (fVec0[(IOTA0 - std::min<int>(2001, std::max<int>(0, iTemp3))) & 2047] * (fTemp4 + fTemp5 - fSlow6) + (fSlow6 + (fRec10[0] - fTemp4)) * fVec0[(IOTA0 - std::min<int>(2001, std::max<int>(0, iTemp3 + 1))) & 2047]) * (1.0f - fTemp0);
			int iTemp7 = int(fRec10[0]);
			float fTemp8 = std::floor(fRec10[0]);
			float fTemp9 = (fVec0[(IOTA0 - std::min<int>(2001, std::max<int>(0, iTemp7))) & 2047] * (fTemp8 + fTemp5) + (fRec10[0] - fTemp8) * fVec0[(IOTA0 - std::min<int>(2001, std::max<int>(0, iTemp7 + 1))) & 2047]) * fTemp0;
			float fTemp10 = fTemp9 + fTemp6;
			fVec1[IOTA0 & 8191] = fTemp10 + fSlow4 * fRec9[0];
			fRec8[0] = fVec1[(IOTA0 - iSlow9) & 8191];
			fRec12[0] = fSlow3 * fRec12[1] + fSlow2 * fRec11[1];
			fVec2[IOTA0 & 8191] = fTemp10 + fSlow4 * fRec12[0];
			fRec11[0] = fVec2[(IOTA0 - iSlow10) & 8191];
			fRec14[0] = fSlow3 * fRec14[1] + fSlow2 * fRec13[1];
			fVec3[IOTA0 & 8191] = fTemp10 + fSlow4 * fRec14[0];
			fRec13[0] = fVec3[(IOTA0 - iSlow11) & 8191];
			fRec16[0] = fSlow3 * fRec16[1] + fSlow2 * fRec15[1];
			fVec4[IOTA0 & 8191] = fTemp10 + fSlow4 * fRec16[0];
			fRec15[0] = fVec4[(IOTA0 - iSlow12) & 8191];
			fRec18[0] = fSlow3 * fRec18[1] + fSlow2 * fRec17[1];
			fVec5[IOTA0 & 8191] = fTemp10 + fSlow4 * fRec18[0];
			fRec17[0] = fVec5[(IOTA0 - iSlow13) & 8191];
			fRec20[0] = fSlow3 * fRec20[1] + fSlow2 * fRec19[1];
			fVec6[IOTA0 & 8191] = fTemp10 + fSlow4 * fRec20[0];
			fRec19[0] = fVec6[(IOTA0 - iSlow14) & 8191];
			fRec22[0] = fSlow3 * fRec22[1] + fSlow2 * fRec21[1];
			fVec7[IOTA0 & 8191] = fTemp10 + fSlow4 * fRec22[0];
			fRec21[0] = fVec7[(IOTA0 - iSlow15) & 8191];
			fRec24[0] = fSlow3 * fRec24[1] + fSlow2 * fRec23[1];
			fVec8[IOTA0 & 8191] = fTemp6 + fSlow4 * fRec24[0] + fTemp9;
			fRec23[0] = fVec8[(IOTA0 - iSlow16) & 8191];
			float fTemp11 = fRec23[0] + fRec21[0] + fRec19[0] + fRec17[0] + fRec15[0] + fRec13[0] + fRec11[0] + fRec8[0] + fSlow1 * fRec6[1];
			fVec9[IOTA0 & 2047] = fTemp11;
			fRec6[0] = fVec9[(IOTA0 - iSlow18) & 2047];
			float fRec7 = -(fSlow1 * fTemp11);
			float fTemp12 = fRec6[1] + fRec7 + fSlow1 * fRec4[1];
			fVec10[IOTA0 & 2047] = fTemp12;
			fRec4[0] = fVec10[(IOTA0 - iSlow19) & 2047];
			float fRec5 = -(fSlow1 * fTemp12);
			float fTemp13 = fRec4[1] + fRec5 + fSlow1 * fRec2[1];
			fVec11[IOTA0 & 2047] = fTemp13;
			fRec2[0] = fVec11[(IOTA0 - iSlow20) & 2047];
			float fRec3 = -(fSlow1 * fTemp13);
			float fTemp14 = fRec2[1] + fRec3 + fSlow1 * fRec0[1];
			fVec12[IOTA0 & 2047] = fTemp14;
			fRec0[0] = fVec12[(IOTA0 - iSlow21) & 2047];
			float fRec1 = -(fSlow1 * fTemp14);
	...
	#define FAUST_FILE_NAME "new_pitchshifter.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("room_size", fHslider0, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("shift", fHslider1, 0.0f, -12.0f, 12.0f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("window", fHslider2, 1e+03f, 5e+01f, 1e+04f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("xfade", fHslider3, 1e+01f, 1.0f, 1e+04f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, room_size, "room_size", fHslider0, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, shift, "shift", fHslider1, 0.0f, -12.0f, 12.0f, 0.1f) \
		p(HORIZONTALSLIDER, window, "window", fHslider2, 1e+03f, 5e+01f, 1e+04f, 1.0f) \
		p(HORIZONTALSLIDER, xfade, "xfade", fHslider3, 1e+01f, 1.0f, 1e+04f, 1.0f) \
...
new_pitchshifter::new_pitchshifter() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void new_pitchshifter::updateImp(void)
{
#if MIDICTRL
...
void new_pitchshifter::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void new_pitchshifter::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float new_pitchshifter::getParamValue(const std::string& path)
{
